...
export function BuscarMusicasFiltradas({indices, valoresMaxMinPorFiltro}){
    ...
    const [offset, setOffset] = useState(0);
        ...
        const buscaDadosDePesquisa = () => {
          if(searchInput != "")
          {
              axios.get(`http://localhost:8080/filtragem/musicas?tagDeProcura=${searchInput}&offset_min=${offset}&offset_max=50&indicesDosFiltros=${indices}&valoresMaxMinPorFiltro=${valoresMaxMinPorFiltro}`).then(res => {
